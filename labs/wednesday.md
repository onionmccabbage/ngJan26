...
* If you wish to develop further features, try test-driven-development (write a spec, write a test, then implement some code)
...
##### Service
* You should be able to use your services as-provided, but consider implementing mock service data

##### Architecture
* Treat these tests as if they will end up in a continuous integration scenario 
* When you have some passing tests, implement another feature (e.g. city and country for weather) and ensure the tests still pass
